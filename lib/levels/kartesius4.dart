...
class Kartesius4 extends StatefulWidget {
  const Kartesius4({super.key});

  @override
  State<Kartesius4> createState() => _Kartesius4State();
}
...
class _Kartesius4State extends State<Kartesius4> {
  @override
...
class _Stage0State extends State<Stage0> {
  ...
  //       context,
  //       MaterialPageRoute(
  //           builder: (BuildContext context) => const Kartesius4()));
  // }
